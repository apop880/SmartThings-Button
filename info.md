...
`tap_device` | True | string || The device to take the action on. Currently, only lights, light groups, switches, and input_booleans are supported.
...
`hold_device` | True | string || The device to take the action on. Currently, only lights, light groups, switches, and input_booleans are supported.
...
`double_device` | True | string || The device to take the action on. Currently, only lights, light groups, switches, and input_booleans are supported.
